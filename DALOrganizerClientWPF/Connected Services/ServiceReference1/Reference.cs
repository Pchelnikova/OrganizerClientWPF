...
namespace DALOrganizerClientWPF.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetAllRangs", ReplyAction="http://tempuri.org/IService1/GetAllRangsResponse")]
        string[] GetAllRangs();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetAllRangs", ReplyAction="http://tempuri.org/IService1/GetAllRangsResponse")]
        System.Threading.Tasks.Task<string[]> GetAllRangsAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_Name_byType_forChart_Expense", ReplyAction="http://tempuri.org/IService1/Get_Name_byType_forChart_ExpenseResponse")]
        string[] Get_Name_byType_forChart_Expense(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_Name_byType_forChart_Expense", ReplyAction="http://tempuri.org/IService1/Get_Name_byType_forChart_ExpenseResponse")]
        System.Threading.Tasks.Task<string[]> Get_Name_byType_forChart_ExpenseAsync(string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_Sum_byType_forChart_Expense", ReplyAction="http://tempuri.org/IService1/Get_Sum_byType_forChart_ExpenseResponse")]
        decimal[] Get_Sum_byType_forChart_Expense(string login, string expense);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_Sum_byType_forChart_Expense", ReplyAction="http://tempuri.org/IService1/Get_Sum_byType_forChart_ExpenseResponse")]
        System.Threading.Tasks.Task<decimal[]> Get_Sum_byType_forChart_ExpenseAsync(string login, string expense);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Delete_Wish", ReplyAction="http://tempuri.org/IService1/Delete_WishResponse")]
        void Delete_Wish(DALOrganizerClientWPF.ServiceReference1.Profit_ExpanceWCF profit_ExpanceWCF, string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Delete_Wish", ReplyAction="http://tempuri.org/IService1/Delete_WishResponse")]
        System.Threading.Tasks.Task Delete_WishAsync(DALOrganizerClientWPF.ServiceReference1.Profit_ExpanceWCF profit_ExpanceWCF, string login);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<DALOrganizerClientWPF.ServiceReference1.IService1>, DALOrganizerClientWPF.ServiceReference1.IService1 {
        ...
        public string[] GetAllRangs() {
            return base.Channel.GetAllRangs();
        }
        
        public System.Threading.Tasks.Task<string[]> GetAllRangsAsync() {
            return base.Channel.GetAllRangsAsync();
        }
        
        public string[] Get_Name_byType_forChart_Expense(string login) {
            return base.Channel.Get_Name_byType_forChart_Expense(login);
        }
        
        public System.Threading.Tasks.Task<string[]> Get_Name_byType_forChart_ExpenseAsync(string login) {
            return base.Channel.Get_Name_byType_forChart_ExpenseAsync(login);
        }
        
        public decimal[] Get_Sum_byType_forChart_Expense(string login, string expense) {
            return base.Channel.Get_Sum_byType_forChart_Expense(login, expense);
        }
        
        public System.Threading.Tasks.Task<decimal[]> Get_Sum_byType_forChart_ExpenseAsync(string login, string expense) {
            return base.Channel.Get_Sum_byType_forChart_ExpenseAsync(login, expense);
        }
        
        public void Delete_Wish(DALOrganizerClientWPF.ServiceReference1.Profit_ExpanceWCF profit_ExpanceWCF, string login) {
            base.Channel.Delete_Wish(profit_ExpanceWCF, login);
        }
        
        public System.Threading.Tasks.Task Delete_WishAsync(DALOrganizerClientWPF.ServiceReference1.Profit_ExpanceWCF profit_ExpanceWCF, string login) {
            return base.Channel.Delete_WishAsync(profit_ExpanceWCF, login);
        }
    }
}
